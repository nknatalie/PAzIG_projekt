...
def load_frame1():
	...
	wybor_cr= Button(page1_start, text="Czas reakcji",command=load_frame2,fg='white',bg='navy')
	wybor_cr.grid(row=3,rowspan=1, column=1,padx=20,pady=40, sticky='ew')
	wybor_tr=Button(page1_start,text="Trening pamięci",command=load_frame3,fg='white',bg='navy')
	wybor_tr.grid(row=3,rowspan=1,column=4,padx=20,pady=40, sticky='ew')
	wybor_ka= Button(page1_start, text="Kolejność matematyczna",command=load_frame3, fg='white',bg='navy' )
	wybor_ka.grid(row=5,rowspan=1, column=1,padx=20,pady=40, sticky='ew')
	wybor_rm= Button(page1_start, text="Równanie matemtyczne",command=load_frame3, fg='white',bg='navy' )
	wybor_rm.grid(row=5,rowspan=1, column=4,padx=20,pady=40, sticky='ew')
